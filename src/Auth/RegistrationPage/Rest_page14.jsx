...
const ResgistPage13 = () => {
    ...
    return (<>
        ...
        <RisgistionBgImg height="100vh" imgUrl={Artboard13}>
            <ResHeaderComponent/>
           <Completeform>
                <div className='completeFormcontent'>
                    <h1 className='thankheaging'>Thank you for completing the form.</h1>
                    <p>The maximum period for review of your profile is 12 hours. Any delays could be as a result of issues with the Profile form, and you can contact us on hello@likeplaylikeplay.com  with your concern.</p>
                </div>
                </Completeform>
